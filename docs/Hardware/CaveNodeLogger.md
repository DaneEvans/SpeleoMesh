...
This is a specialised unit, which allows the logging of all traffic on the network to an SD card, for records, or for analysis. 


**Non waterproof, currently**
- 18650 Battery for up to 5 days of battery. (likely with no LEDs)
