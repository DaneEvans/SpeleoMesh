...
Another few were likely available to extend the dry way radios, but the next group was a lot further down the cave, and reaching them seemed unlikely. 
...
- [x] Verify that all devices survived
    ...
    - [ ] all others 
- [ ] Verify that ADRT commands are happening on channel / figure out how / why several started sending htem out at one point. 
- [ ] Figure out what went wrong with the serial link - wire gauge, connectors etc. 
